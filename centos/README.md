...
| 文件 | 说明 |
|---|---|
| [config-time-locale.sh](config-time-locale.sh) | CentOS / Ubuntu 通用时间与地区初始化脚本：设置 timezone、locale，启用 NTP(systemd-timesyncd / chrony / chronyd)，默认 `Asia/Shanghai` + `zh_CN.UTF-8` |
