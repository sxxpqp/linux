...
> 这是给 Codex 看的。人类索引见 [README.md](README.md)。
> 任何关于本仓库的对话,先读这里,再读对应子目录的 AGENTS.md / README.md。
...
需要在某个子目录建立独立上下文时,在那里加一份 AGENTS.md(参考 `network/mihomo/AGENTS.md`)。
