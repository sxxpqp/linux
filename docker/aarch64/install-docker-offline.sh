...
DOWNLOAD_URL="https://chfs.sxxpqp.top:8443/chfs/shared/linux/docker/aarch64" # 下载 URL
...
function install_docker_compose() {
    ...
    local compose_file="$DOCKER_DIR/docker-compose-linux-aarch64"
    download_file "$DOWNLOAD_URL/docker-compose-linux-aarch64" "$compose_file"
