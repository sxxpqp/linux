...
if [ "$OS" = "Darwin" ]; then
    ...
    DOWNLOAD_URL="https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/ollama/ollama/releases/latest/download/Ollama-darwin.zip${VER_PARAM}"
...
download_and_extract "https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}"
...
if [ -f /etc/nv_tegra_release ] ; then
    if grep R36 /etc/nv_tegra_release > /dev/null ; then
        download_and_extract "https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-jetpack6"
    elif grep R35 /etc/nv_tegra_release > /dev/null ; then
        download_and_extract "https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-jetpack5"
    else
...
if check_gpu lspci amdgpu || check_gpu lshw amdgpu; then
    download_and_extract "https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-rocm"
