...
URL="https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/istio/istio/releases/download/${ISTIO_VERSION}/istio-${ISTIO_VERSION}-${OSEXT}.tar.gz"
ARCH_URL="https://nexus.ihome.sxxpqp.top:8443/repository/raw-github/istio/istio/releases/download/${ISTIO_VERSION}/istio-${ISTIO_VERSION}-${OSEXT}-${ISTIO_ARCH}.tar.gz"
