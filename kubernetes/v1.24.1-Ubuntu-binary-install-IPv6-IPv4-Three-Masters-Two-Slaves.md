...
| 主机名称 | IP地址       | 说明       | 软件                                                         |
| -------- | ------------ | ---------- | ------------------------------------------------------------ |
| Master01 | 192.168.1.191 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived |
| Master02 | 192.168.1.192 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived |
| Master03 | 192.168.1.193 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived |
| Node01   | 192.168.1.194 | node节点   | kubelet、kube-proxy、nfs-client                              |
| Node02   | 192.168.1.195 | node节点   | kubelet、kube-proxy、nfs-client                              |
|          | 192.168.1.190 | VIP        |                                                              |
...
# 客户端安装一条命令
apt install chrony -y ; sed -i "s#2.centos.pool.ntp.org#192.168.1.191#g" /etc/chrony/chrony.conf ; systemctl restart chronyd ; systemctl enable chronyd
...
export IP="192.168.1.191 192.168.1.192 192.168.1.193 192.168.1.194 192.168.1.195"
...
192.168.1.191 k8s-master01
192.168.1.192 k8s-master02
192.168.1.193 k8s-master03
192.168.1.194 k8s-node01
192.168.1.195 k8s-node02
192.168.1.190 lb-vip
EOF
```
...
for NODE in $Master; do echo $NODE; scp cni-plugins-linux-amd64-v1.1.1.tgz $NODE:/root ; done

for NODE in $Work; do     scp cni-plugins-linux-amd64-v1.1.1.tgz $NODE:/root ; done
...
for NODE in $Master; do echo $NODE; scp cri-containerd-cni-1.6.4-linux-amd64.tar.gz $NODE:/root ; done

for NODE in $Work; do     scp cri-containerd-cni-1.6.4-linux-amd64.tar.gz $NODE:/root ; done
#解压
...
for NODE in $Master; do echo $NODE; scp crictl-v1.24.2-linux-amd64.tar.gz $NODE:/root ; done

for NODE in $Work; do     scp crictl-v1.24.2-linux-amd64.tar.gz $NODE:/root ; done
#解压
...
cfssl gencert \
   ...
   -hostname=127.0.0.1,k8s-master01,k8s-master02,k8s-master03,192.168.1.191,192.168.1.192,192.168.1.193,2408:8207:78ca:9fa1::10,2408:8207:78ca:9fa1::20,2408:8207:78ca:9fa1::30 \
   -profile=kubernetes \
...
# 10.96.0.1是service网段的第一个地址，需要计算，192.168.1.190为高可用vip地址

cfssl gencert   \
-ca=/etc/kubernetes/pki/ca.pem   \
-ca-key=/etc/kubernetes/pki/ca-key.pem   \
-config=ca-config.json   \
-hostname=10.96.0.1,192.168.1.190,127.0.0.1,kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,x.oiox.cn,k.oiox.cn,l.oiox.cn,o.oiox.cn,192.168.1.191,192.168.1.192,192.168.1.193,192.168.1.194,192.168.1.195,192.168.1.16,192.168.1.17,192.168.1.18,2408:8207:78ca:9fa1::10,2408:8207:78ca:9fa1::20,2408:8207:78ca:9fa1::30,2408:8207:78ca:9fa1::40,2408:8207:78ca:9fa1::50,2408:8207:78ca:9fa1::60,2408:8207:78ca:9fa1::70,2408:8207:78ca:9fa1::80,2408:8207:78ca:9fa1::90,2408:8207:78ca:9fa1::100   \
...
kubectl config set-cluster kubernetes \
     ...
     --embed-certs=true \
     --server=https://192.168.1.190:8443 \
...
listen-peer-urls: 'https://192.168.1.191:2380'
listen-client-urls: 'https://192.168.1.191:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.1.191:2380'
advertise-client-urls: 'https://192.168.1.191:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
initial-cluster: 'k8s-master01=https://192.168.1.191:2380,k8s-master02=https://192.168.1.192:2380,k8s-master03=https://192.168.1.193:2380'
...
election-timeout: 1000
quota-backend-bytes: 0
listen-peer-urls: 'https://192.168.1.192:2380'
listen-client-urls: 'https://192.168.1.192:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.1.192:2380'
advertise-client-urls: 'https://192.168.1.192:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
...
listen-client-urls: 'https://192.168.1.193:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
...
etcdctl --endpoints="192.168.1.193:2379,192.168.1.192:2379,192.168.1.191:2379" --cacert=/etc/kubernetes/pki/etcd/etcd-ca.pem --cert=/etc/kubernetes/pki/etcd/etcd.pem --key=/etc/kubernetes/pki/etcd/etcd-key.pem  endpoint status --write-out=table
+----------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
|    ENDPOINT    |        ID        | VERSION | DB SIZE | IS LEADER | IS LEARNER | RAFT TERM | RAFT INDEX | RAFT APPLIED INDEX | ERRORS |
+----------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| 192.168.1.193:2379 | c0c8142615b9523f |   3.5.4 |   20 kB |     false |      false |         2 |          9 |                  9 |        |
| 192.168.1.192:2379 | de8396604d2c160d |   3.5.4 |   20 kB |     false |      false |         2 |          9 |                  9 |        |
| 192.168.1.191:2379 | 33c9d6df0037ab97 |   3.5.4 |   20 kB |      true |      false |         2 |          9 |                  9 |        |
+----------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
...
backend k8s-master
 ...
 server  k8s-master01  192.168.1.191:6443 check
 server  k8s-master02  192.168.1.192:6443 check
 server  k8s-master03  192.168.1.193:6443 check
EOF
```
...
[root@k8s-node02 ~]# ping 192.168.1.190

# 能telnet访问

[root@k8s-node02 ~]# telnet 192.168.1.190 8443
...
ExecStart=/usr/local/bin/kube-apiserver \
      ...
      --secure-port=6443  \
      --advertise-address=192.168.1.191 \
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \
      --feature-gates=IPv6DualStack=true  \
      --service-node-port-range=30000-32767  \
      --etcd-servers=https://192.168.1.191:2379,https://192.168.1.192:2379,https://192.168.1.193:2379 \
...
ExecStart=/usr/local/bin/kube-apiserver \
      ...
      --bind-address=0.0.0.0  \
      --secure-port=6443  \
      --advertise-address=192.168.1.192 \
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \
			--feature-gates=IPv6DualStack=true \
      --service-node-port-range=30000-32767  \
      --etcd-servers=https://192.168.1.191:2379,https://192.168.1.192:2379,https://192.168.1.193:2379 \
...
kubectl config set-cluster kubernetes     \
--certificate-authority=/etc/kubernetes/pki/ca.pem     \
--embed-certs=true     --server=https://192.168.1.190:8443     \
...
calico-node-fvbdq                          1/1     Running   1 (75m ago)   77m   192.168.1.191     k8s-master01   <none>           <none>
calico-node-g8nqd                          1/1     Running   0             77m   192.168.1.194     k8s-node01     <none>           <none>
calico-node-mdps8                          1/1     Running   0             77m   192.168.1.195     k8s-node02     <none>           <none>
calico-node-nf4nt                          1/1     Running   0             77m   192.168.1.193     k8s-master03   <none>           <none>
calico-node-sq2ml                          1/1     Running   0             77m   192.168.1.192     k8s-master02   <none>           <none>
calico-typha-8445487f56-mg6p8              1/1     Running   0             77m   192.168.1.195     k8s-node02     <none>           <none>
calico-typha-8445487f56-pxbpj              1/1     Running   0             77m   192.168.1.191     k8s-master01   <none>           <none>
calico-typha-8445487f56-tnssl              1/1     Running   0             77m   192.168.1.194     k8s-node01     <none>           <none>
...
64 bytes from 192.168.1.194: seq=0 ttl=63 time=0.358 ms
64 bytes from 192.168.1.194: seq=1 ttl=63 time=0.668 ms
64 bytes from 192.168.1.194: seq=2 ttl=63 time=0.637 ms
64 bytes from 192.168.1.194: seq=3 ttl=63 time=0.624 ms
64 bytes from 192.168.1.194: seq=4 ttl=63 time=0.907 ms
...
ingress-host-bar   nginx   hello.chenby.cn,demo.chenby.cn   192.168.1.192   80      7s
...
[root@localhost yaml]# curl -I http://192.168.1.191:30779
HTTP/1.1 200 OK
Server: nginx/1.21.6
